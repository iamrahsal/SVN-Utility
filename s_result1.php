...
session_start();
    ...
    if(!isset($_SESSION['sess_username']) || $role!="Business Analyst"){
...
$query1=mysqli_query($con,"SELECT search_word from search where userid='$uname'");
$query2=mysqli_fetch_array( $query1,MYSQLI_ASSOC);

$s_value=$query2['search_word'];
$b=$s_value;
	...
	<div class="top">
		...
		<div id="head">
			...
			<div id="mySidenav" class="sidenav">
				  ...
				  <a href="ba.php">Dashboard</a>
				  <a href="ba.php">Search</a>
...
?>
	...
	<div class="right">
		...
		<?php
$cmd1="svn log file:///C:/ver/v3.0/trunk/code/abd.code";
