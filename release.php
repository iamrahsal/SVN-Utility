...
<head lang="en">
	...
	<title>SVN UTILITY-Releaser</title>
		...
		<div class="tab-pane fade active in" id="home">
			<div class="container">
					<div class="items sentr">
						<a href="search1.php" class="smoothScroll"><img src="img/search.png" class="imag" height="25%" width="25%"></a>
						<a href="deploy1.php" class="smoothScroll"><img src="img/rel.png" class="imag" height="25%" width="25%"></a>
					</div>
			</div>
		</div>
