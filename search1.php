...
mysqli_query($con,$query);
	...
	$ver = $_POST['ver'];
	header("Location:s_result_r.php");
	}
	}
?>
		...
		<div class="picc">
				...
				<form method="POST" action="">
					   ...
					   <div class="search">
						 ...
						 <div style="position:absolute; left:100%;padding-left: 50px;">

						 <button id="myButton2" onclick="window.history.go(-1);" class="searchButton" style="border-radius: 50%;">
